...
(function (RENDERER) {
    ...
    var Camera = function (entity, scene_in, renderer_in) {
        ...
        var _setupTex = function () {
            ...
            tex['interaction']['normal']['door'][_Data.operation.door.Destroy] = textureLoader.load(path + 'interaction.key.png');
            ...
            tex['interaction']['highlight']['door'][_Data.operation.door.Destroy] = textureLoader.load(path + 'interaction.key-2.png');
